...
<a class="nav-link" data-widget="navbar-search" href="#" role="button">
        ...
        <div class="navbar-search-block">
          <form class="form-inline" type="GET" action="{{route('search_teams')}}">
            <div class="input-group input-group-sm" >
              <input class="form-control form-control-navbar" name="T_search" type="search" placeholder="Search Teams" aria-label="Search">
